...
export const pomodoroTechnique: Article = {
  ...
  description:
    'Learn what the Pomodoro Technique is, why it improves focus, and how to use it step-by-step. Includes science-backed tips and a free timer to get you started.',
  date: '2025-06-08',
